 ...
 */
final class Version20220821105404 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE check_list CHANGE status status TINYINT(1) DEFAULT 0 NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE check_list CHANGE status status TINYINT(1) DEFAULT NULL');
